...
> [!IMPORTANT]
> 事前に、 `yourwork/discovery/README.md` の "Listen" セクションが記載され保存されていることを確認してください。
...
> [!IMPORTANT]
> 事前に、Define まで終了した `yourwork/discovery/README.md` が全員に共有されているか確認してください。
...
> [!IMPORTANT]
> 事前に、Refine で作成したプレスリリースが `yourwork/discovery/README.md` に記載されているか確認してください。
